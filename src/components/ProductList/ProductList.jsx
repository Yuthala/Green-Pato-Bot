...
const ProductList = () => {
	...
	const onSendData = useCallback(() => {
        ...
        fetch('http://localhost:8000/web_data', { //указать актуальный публичный IP-адрес сервера, где лежит бот, и /web_data (в данном примере) - взять эндпоинт из строки app.post первый аргумент
			method: 'POST',
			headers: {
